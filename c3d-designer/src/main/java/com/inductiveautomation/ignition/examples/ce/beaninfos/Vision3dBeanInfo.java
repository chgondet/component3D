...
import static com.inductiveautomation.ignition.examples.ce.components.Vision3d.ANIMATION_LTR;
import static com.inductiveautomation.ignition.examples.ce.components.Vision3d.ANIMATION_OFF;
import static com.inductiveautomation.ignition.examples.ce.components.Vision3d.ANIMATION_RTL;
...
/**
 * This BeanInfo class describes the {@link Vision3d}, which is the component that this example module adds
 * to the Vision Module
 *
 * @author Carl Gould
 */
public class Vision3dBeanInfo extends CommonBeanInfo {

    public Vision3dBeanInfo() {
        /*
         * Our superclass constructor takes the class of the component we describe and the customizers that are
         * applicable
         */
        super(Vision3d.class, DynamicPropertyProviderCustomizer.VALUE_DESCRIPTOR, StyleCustomizer.VALUE_DESCRIPTOR);
    }
    ...
    protected void initProperties() throws IntrospectionException {
        ...
        addProp("hydrogenColor", "Hydrogen Color", "The color to fill the hydrogen with.", CAT_APPEARANCE, PREFERRED_MASK);
        addProp("hydrogenSpecular", "Hydrogen Specular", "The color to fill the hydrogen with.", CAT_APPEARANCE, PREFERRED_MASK);
        addProp("oxygenColor", "Oxygen Color", "The color to fill the hydrogen with.", CAT_APPEARANCE, PREFERRED_MASK);
        addProp("oxygenSpecular", "Oxygen Specular", "The color to fill the hydrogen with.", CAT_APPEARANCE, PREFERRED_MASK);
    ...
    protected void initDesc() {
        ...
        // Alter Vision3dTermFinder to add static and dynamic props
        bean.setValue(CommonBeanInfo.TERM_FINDER_CLASS, Vision3dTermFinder.class);
    }
