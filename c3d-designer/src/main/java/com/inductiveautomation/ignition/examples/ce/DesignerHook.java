...
public class DesignerHook extends AbstractDesignerModuleHook {
    ...
    public static final String MODULE_ID = "component-vision3D";
    ...
    public void startup(DesignerContext context, LicenseState activationState) throws Exception {
        ...
        if (sdk != null) {
            ...
            PaletteItemGroup group = palette.addGroup("IT-Mation");
            group.addPaletteItem(new JavaBeanPaletteItem(Vision3d.class));
        }
    }
